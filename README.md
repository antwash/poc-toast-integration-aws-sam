...
```bash
toast-integration-locally-sam$ sam build
```
...
```bash
toast-integration-locally-sam$ sam logs -n StockCheckerFunction --stack-name toast-integration-locally-sam --tail
```
...
```bash
toast-integration-locally-sam$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name toast-integration-locally-sam
```
